...
public class MailVerifyCode {
	...
	public void sendMessage() throws MessagingException, UnsupportedEncodingException {
        ...
        // 发件人的账号
        props.put("mail.user", mailConfiguration.getUserMail());
        // 访问SMTP服务时需要提供的密码 
        props.put("mail.password", mailConfiguration.getPassword());
	...
	public MailVerifyCode(MailConfiguration mailConfiguration) {
		super();
